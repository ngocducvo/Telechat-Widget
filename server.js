		...
		if (!req.body.callback_query) {
			...
			if (text.startsWith('/start')) {
				...
				sendTelegramMessage(chatId,
					...
					'`/info` - more information about Bot\n' +
			...
			if (text.startsWith('/help')) {
				...
				sendTelegramMessage(chatId,
					...
					'*1.)* We need to add Bot to hotspot walled-garden by pasting this following command in the *terminal*\n\n' +
			...
			if (text.startsWith('/info')) {
				...
				sendTelegramMessage(chatId,
					...
					'@Bot is a fork of [Kintoyyy/Telegram-Chat-Widget](https://github.com/Kintoyyy/Telegram-Chat-Widget) and [idoco/intergram](https://github.com/idoco/intergram) and [yamaha252/intergram](https://github.com/yamaha252/intergram) Consider giving the repositories a ⭐ to show some support\n\n' +
